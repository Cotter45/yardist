...
export default function Contact() {
  ...
  return (
    ...
    >
      ...
      <p className="w-full self-center max-w-[600px] pt-10 pl-6 text-neutral-300 z-10 indent-2">
      ...
      <form
        ...
        encType="text/plain"
        className="w-full h-full relative z-40 flex flex-col gap-8"
      >
        <div className="h-full flex flex-col items-center justify-evenly -mx-3 mb-6">
          ...
          <div className="w-[85%] md:w-1/2 max-w-[800px]">
            <label className="block uppercase tracking-wide text-white text-xs font-bold mb-2">
              Message
            </label>
            <textarea
          ...
          <div className="w-[90%] md:w-1/2 max-w-[800px] flex justify-center">
            <button
              type="submit"
              className="w-full max-w-[400px] bg-yellow-900 text-white py-2 px-16 rounded cursor-pointer shadow-md shadow-neutral-800 hover:shadow-lg hover:scale-105 transition-all ease-in-out duration-500 flex gap-4 md:gap-8 justify-center items-center self-center"
            >
              Submit
            </button>
          </div>
